      ...
      <Container className="overflow-x-hidden">
        ...
        <div className="flex flex-col">
          ...
          <div className="flex flex-row">
            {/* All 7 Strains Pack */}
            <div className="w-1/2 bg-yellow-300 p-6 small:p-10 flex flex-col justify-between">
          ...
          <div className="flex flex-row">
            ...
            {/* Merch Pack */}
            <div className="w-1/2 bg-purple-700 p-6 small:p-10 flex flex-col justify-between text-white">
              <div className="space-y-4">
