  ...
  return (
    <div className="w-full overflow-x-hidden">
      <Container className="overflow-x-hidden">
        ...
        <div className="grid grid-cols-1 small:grid-cols-2 gap-0 mx-auto overflow-hidden">
          {/* All 7 Strains Pack */}
          <div className="bg-yellow-300 p-6 small:p-10 flex flex-col justify-between">
          ...
          {/* Strains Image */}
          <div className="relative h-80 small:h-full">
            <Image
          ...
          {/* Merch Image */}
          <div className="relative h-80 small:h-full order-4 small:order-3">
            <Image
              src="/placeholder.svg?height=500&width=500"
          ...
          {/* Merch Pack */}
          <div className="bg-purple-700 p-6 small:p-10 flex flex-col justify-between text-white order-3 small:order-4">
            <div className="space-y-4">
