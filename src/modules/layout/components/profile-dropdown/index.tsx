  ...
  return (
    <Box className="z-50 h-full" onMouseEnter={open} onMouseLeave={close}>
      <Popover className="relative h-full">
        <Popover.Button
          className="cursor-default rounded-full bg-transparent !p-2 text-white outline-none hover:text-white active:bg-fg-secondary-pressed active:text-white xsmall:!p-3.5 small:hover:bg-fg-secondary-hover"
